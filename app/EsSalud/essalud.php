<?php
	...
	namespace App\EsSalud;
	use App\EsSalud\cURL;
	use App\EsSalud\obj;
	class EsSalud
	{
	    private  $respuesta;
		...
		public function search( $dni )
		{
			...
			if( $this->cc->getHttpStatus() == 200 && $code != "")
			{
				...
				if( isset($json->DatosPerson[0])  && strlen($json->DatosPerson[0]->DNI)>=8 && $json->DatosPerson[0]->Nombres != "" )
				{
